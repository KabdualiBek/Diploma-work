...
\begin{figure}[H]
	\centering
	\includegraphics[trim={2.4cm, 0.6cm, 0, 1.5cm}, clip, scale=0.62]{First3.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[trim={2.5cm, 0, 0, 1.5cm}, clip, scale=0.62]{Second3.png}
	\caption{Погрешность аппроксимации $E(x)$}
	\label{fig:image3}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[trim={2.1cm, 0, 0, 1.5cm}, clip, scale=0.61]{Third3.png}
	\caption{Погрешность аппроксимации $E(x)$}
	\label{fig:image5}
\end{figure}
